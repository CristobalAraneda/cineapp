    ...
    ================================================== -->
				...
				<c:forEach items = "${banners }" var="banner" varStatus ="loop">
				 <c:choose>
				  <c:when test="${loop.index==0}">
				   <li data-target = "#myCarusel" data-slide-to ="${loop.index }" class="active"></li>
				  </c:when>
				  <c:otherwise>
				   <li data-target = "#myCarusel" data-slide-to ="${loop.index }"></li>
				  </c:otherwise>
				 </c:choose>
				</c:forEach>
			</ol>
		...
		<div class="row page-header">
			<div class="col-lg-12">
				...
				<form class="form-inline" action="${urlRoot}seach" method="post">
